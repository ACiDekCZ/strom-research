...
it one folder per plugin. The folder's name is the plugin's name.
    ...
    plugins/
      ...
      hooks/                   your programs told of what is saved into a research
        README.md              their interface (version 1)
...
**Hooks** are told of what is saved into a research — a person found, a
session closed — and do with it what you want (a message to your phone, a
log): `strom hook on <name>` (only you), `strom hook test <name>`.
...
`connectors/README.md`, `gates/README.md`, `hooks/README.md` and the gates it ships, and keeps them
up to date.
